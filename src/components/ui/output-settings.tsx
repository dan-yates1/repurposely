import { ChevronDown, Type, BarChart2, Tag } from 'lucide-react';
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <select
              ...
              className="block w-full pl-3 pr-10 py-2 text-sm border border-gray-300 bg-white rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 appearance-none"
            >
